  ...
  const games = [
    {
      id: "mistr",
      title: "BARF Mistr",
      tag: t("zabava.tag_quiz"),
      description: t("zabava.game1_desc"),
      emoji: "🧠",
      colorLight: "#f7fde8",
      colorBorder: "#d4ed85",
      tagBg: "#f7fde8",
    ...
    },
    {
      id: "lovec",
      title: "BARF Lovec",
      tag: t("zabava.tag_arcade"),
      description: t("zabava.game2_desc"),
      emoji: "🎯",
      colorLight: "#f5f3ff",
      colorBorder: "#ddd6fe",
      tagBg: "#f5f3ff",
    ...
    <div className="min-h-screen bg-[#f2f4f7]">
      ...
      <main className="mx-auto max-w-[1100px] px-4 py-10 sm:px-6">
        ...
        <div className="mt-12 rounded-3xl bg-textdark px-8 py-10 text-center">
          <p className="mb-1 text-sm font-semibold tracking-widest text-[#c3e96b]">{t("zabava.cta_label")}</p>
          <h2 className="mt-2 [font-family:'Inter',Helvetica] text-[26px] font-normal text-white sm:text-[32px]">
            {t("zabava.cta_title")}
          </h2>
          <p className="mt-3 text-[#ffffffb8]">{t("zabava.cta_desc")}</p>
          <a
            href="/stazeni"
