    ...
    return (
      <div className="flex min-h-screen flex-col bg-[#f2f4f7]">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-4 text-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-700">Článek nenalezen</h1>
      ...
      <main className="mx-auto max-w-[780px] px-6 py-12">
        ...
        <nav className="mt-8 grid gap-4 sm:grid-cols-2">
          {prev ? (
            <Link
              to={`/novinky/${prev.id}`}
              className="group flex flex-col gap-1 rounded-2xl border border-gray-200 bg-white p-5 transition-all hover:border-[#c3e366] hover:shadow-sm"
            >
              ...
              <span className="line-clamp-2 text-sm font-medium text-gray-700 group-hover:text-[#506600]">
                {prev.title}
              </span>
            </Link>
          ) : (
          ...
          {next ? (
            <Link
              to={`/novinky/${next.id}`}
              className="group flex flex-col items-end gap-1 rounded-2xl border border-gray-200 bg-white p-5 text-right transition-all hover:border-[#c3e366] hover:shadow-sm"
            >
              <span className="flex items-center gap-1 text-xs font-semibold uppercase tracking-wide text-gray-400">
                Další článek
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mt-8 text-center">
          <Link
            to="/novinky"
            className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-6 py-2.5 text-sm font-medium text-gray-600 transition-all hover:border-[#c3e366] hover:text-gray-900"
          >
